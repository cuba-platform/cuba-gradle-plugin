...
package com.haulmont.gradle.hsql;
...
public class CubaHSQLDBServer extends JFrame {
    ...
    public static void main(final String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            CubaHSQLDBServer monitor = new CubaHSQLDBServer();
            ...
            if (validInit) {
                ...
                HSQLServer server = monitor.startServer(dbPort, dbPath, dbName);
                if (server != null) {
            ...
            SwingUtilities.invokeLater(() -> {
                try {
                    ...
                    if (state == 16) {
                        ...
                        // close window
                        monitor.dispatchEvent(new WindowEvent(monitor, WindowEvent.WINDOW_CLOSING));
                        System.exit(0);
                    }
