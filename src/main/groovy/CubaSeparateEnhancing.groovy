...
/**
 * In general case, entities enhancing is done using the {@link CubaEnhancingAction} action as a part of {@code compileJava} or {@code compileKotlin}
 ...
 *
 * In these cases {@link CubaEnhancingAction}s should not be added to compile tasks and enhancing must be done with the {@link CubaSeparateEnhancing}
 * task.
 */
class CubaSeparateEnhancing extends DefaultTask {

    String sourceSetName

    CubaSeparateEnhancing() {
